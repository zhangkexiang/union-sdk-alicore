<?php
namespace Union\Sdk\AliCore\Profile;

use Union\Sdk\AliCore\Auth\Credential;
use Union\Sdk\AliCore\Auth\ShaHmac1Signer;
use Union\Sdk\AliCore\Regions\EndpointProvider;
use Union\Sdk\AliCore\Regions\ProductDomain;
